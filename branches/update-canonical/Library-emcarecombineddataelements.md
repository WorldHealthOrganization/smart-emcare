# EmCare.CombinedDataElements - WHO FHIR Implementation Guide (IG): Integrated Management of Childhood Illness (IMCI) in emergencies v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **EmCare.CombinedDataElements**

## Library: EmCare.CombinedDataElements 

| | |
| :--- | :--- |
| *Official URL*:https://smart.who.int/ccc/Library/emcarecombineddataelements | *Version*:0.1.0 |
| Active as of 2026-04-07 | *Computable Name*:emcarecombineddataelements |
| *Other Identifiers:*emcare.combineddataelements (use: official, ) | |
...
* **Name**: emcare.b12s1.de01
  ...
  * **Min**: 
  * **Max**: 
  * **In/Out**: Out: emcarecombineddataelements
* **Parameters: **: **Version: **
  * * **Name**: child
  * **Type**: boolean
  * **Min**: 
...
* **Name**: emcare.b12s1.de01
  ...
  * **Min**: 
  * **Max**: 
  * **In/Out**: Out: [EmCare.CombinedDataElements](Library-emcarecombineddataelements.md)
* **Parameters: **: ** Official **
  * * **Name**: child
  * **Type**: boolean
  * **Min**: 
...
* **Name**: emcare.b12s1.de01
  ...
  * **Min**: 
  * **Max**: 
  * **In/Out**: Out:  emcare.combineddataelements 
* **Parameters: **: **Date: **
  * * **Name**: child
  * **Type**: boolean
  * **Min**: 
...
```json
{
  ...
  "url" : "https://smart.who.int/ccc/Library/emcarecombineddataelements",
  "identifier" : [{
    "use" : "official",
