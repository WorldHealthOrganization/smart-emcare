...
## ActivityDefinition: Ccc.b10-16.signs.2m.p 

| | |
| :--- | :--- |
| *Official URL*:https://smart.who.int/ccc/ActivityDefinition/Ccc.b10-16.signs.2m.p | *Version*:0.1.0 |
| Active as of 2026-04-07 | *Computable Name*: |
| **Usage:**Workflow Task: Collect infornation with questionnaire Ccc.B10-16.Signs.2m.p | |
...
```json
{
  ...
  },
  {
    ...
    "valueCanonical" : "https://smart.who.int/ccc/Questionnaire/Ccc.b10-16.signs.2m.p"
  }],
  "url" : "https://smart.who.int/ccc/ActivityDefinition/Ccc.b10-16.signs.2m.p",
  "version" : "0.1.0",
  "status" : "active",
  "experimental" : false,
  ...
  "useContext" : [{
    ...
    "valueCodeableConcept" : {
      "coding" : [{
        ...
        "code" : "PATDOC",
        "display" : "Collect infornation with questionnaire Ccc.B10-16.Signs.2m.p"
      }]
    }
  }],
  "jurisdiction" : [{
