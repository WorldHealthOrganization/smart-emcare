# emcare.b22.bronchodilatortest - WHO FHIR Implementation Guide (IG): Integrated Management of Childhood Illness (IMCI) in emergencies v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **emcare.b22.bronchodilatortest**

## ActivityDefinition: emcare.b22.bronchodilatortest 

| | |
| :--- | :--- |
| *Official URL*:https://smart.who.int/ccc/ActivityDefinition/emcare.b22.bronchodilatortest | *Version*:0.1.0 |
| Active as of 2026-04-07 | *Computable Name*: |
| **Usage:**Workflow Task: Collect infornation with questionnaire EmCare.B22.BronchodilatorTest | |
...
```json
{
  ...
  "url" : "https://smart.who.int/ccc/ActivityDefinition/emcare.b22.bronchodilatortest",
  "version" : "0.1.0",
  "status" : "active",
  "experimental" : false,
