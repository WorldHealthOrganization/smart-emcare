...
## ActivityDefinition: Cccb.registration.e 

| | |
| :--- | :--- |
| *Official URL*:https://smart.who.int/ccc/ActivityDefinition/Cccb.registration.e | *Version*:0.1.0 |
| Active as of 2026-04-07 | *Computable Name*: |
| **Usage:**Workflow Task: Collect infornation with questionnaire CccB.Registration.E | |
...
```json
{
  ...
  },
  {
    ...
    "valueCanonical" : "https://smart.who.int/ccc/Questionnaire/Cccb.registration.e"
  }],
  "url" : "https://smart.who.int/ccc/ActivityDefinition/Cccb.registration.e",
  "version" : "0.1.0",
  "status" : "active",
  "experimental" : false,
  ...
  "useContext" : [{
    ...
    "valueCodeableConcept" : {
      "coding" : [{
        ...
        "code" : "PATDOC",
        "display" : "Collect infornation with questionnaire CccB.Registration.E"
      }]
    }
  }],
  "jurisdiction" : [{
