...
## ActivityDefinition: emcare.b23.classification.m 

| | |
| :--- | :--- |
| *Official URL*:https://smart.who.int/ccc/ActivityDefinition/emcare.b23.classification.m | *Version*:0.1.0 |
| Active as of 2026-04-07 | *Computable Name*: |
| **Usage:**Workflow Task: Collect infornation with questionnaire EmCare.B23.Classification.m | |
...
* **Code: **: **Date (date last changed): **
  * **system: **[http://hl7.org/fhir/uv/cpg/CodeSystem/cpg-activity-type](http://hl7.org/fhir/uv/cpg/CodeSystem/cpg-activity-type)**code: **collect-information**display: **Collect information: 2026-04-07 12:55:48+0000
...
```json
{
  ...
  },
  {
    ...
    "valueCanonical" : "https://smart.who.int/ccc/Questionnaire/emcare.b23.classification.m"
  }],
  "url" : "https://smart.who.int/ccc/ActivityDefinition/emcare.b23.classification.m",
  "version" : "0.1.0",
  "status" : "active",
  "experimental" : false,
  ...
  "useContext" : [{
    ...
    "valueCodeableConcept" : {
      "coding" : [{
        ...
        "code" : "PATDOC",
        "display" : "Collect infornation with questionnaire EmCare.B23.Classification.m"
      }]
    }
  }],
  "jurisdiction" : [{
