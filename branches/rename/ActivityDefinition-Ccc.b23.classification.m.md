...
## ActivityDefinition: Ccc.b23.classification.m 

| | |
| :--- | :--- |
| *Official URL*:https://smart.who.int/ccc/ActivityDefinition/Ccc.b23.classification.m | *Version*:0.1.0 |
| Active as of 2026-04-07 | *Computable Name*: |
| **Usage:**Workflow Task: Collect infornation with questionnaire Ccc.B23.Classification.m | |
...
```json
{
  ...
  },
  {
    ...
    "valueCanonical" : "https://smart.who.int/ccc/Questionnaire/Ccc.b23.classification.m"
  }],
  "url" : "https://smart.who.int/ccc/ActivityDefinition/Ccc.b23.classification.m",
  "version" : "0.1.0",
  "status" : "active",
  "experimental" : false,
  ...
  "useContext" : [{
    ...
    "valueCodeableConcept" : {
      "coding" : [{
        ...
        "code" : "PATDOC",
        "display" : "Collect infornation with questionnaire Ccc.B23.Classification.m"
      }]
    }
  }],
  "jurisdiction" : [{
