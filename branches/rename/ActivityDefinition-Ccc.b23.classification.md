...
## ActivityDefinition: Ccc.b23.classification 

| | |
| :--- | :--- |
| *Official URL*:https://smart.who.int/ccc/ActivityDefinition/Ccc.b23.classification | *Version*:0.1.0 |
| Active as of 2026-04-07 | *Computable Name*: |
| **Usage:**Workflow Task: Collect infornation with questionnaire Ccc.B23.Classification | |
...
* **Code: **: **Date (date last changed): **
  * **system: **[http://hl7.org/fhir/uv/cpg/CodeSystem/cpg-activity-type](http://hl7.org/fhir/uv/cpg/CodeSystem/cpg-activity-type)**code: **collect-information**display: **Collect information: 2026-04-07 13:36:32+0000
...
```json
{
  ...
  },
  {
    ...
    "valueCanonical" : "https://smart.who.int/ccc/Questionnaire/Ccc.b23.classification"
  }],
  "url" : "https://smart.who.int/ccc/ActivityDefinition/Ccc.b23.classification",
  "version" : "0.1.0",
  "status" : "active",
  "experimental" : false,
  ...
  "useContext" : [{
    ...
    "valueCodeableConcept" : {
      "coding" : [{
        ...
        "code" : "PATDOC",
        "display" : "Collect infornation with questionnaire Ccc.B23.Classification"
      }]
    }
  }],
  "jurisdiction" : [{
