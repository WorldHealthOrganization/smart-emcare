...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      ...
      <sch:assert test="count(f:extension[@url = 'https://fhir.dk.swisstph-mis.ch/matchbox/fhir/StructureDefinition/anonymous']) &lt;= 1">extension with URL = 'https://fhir.dk.swisstph-mis.ch/matchbox/fhir/StructureDefinition/anonymous': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.dk.swisstph-mis.ch/matchbox/fhir/StructureDefinition/birthTime']) &lt;= 1">extension with URL = 'https://fhir.dk.swisstph-mis.ch/matchbox/fhir/StructureDefinition/birthTime': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.dk.swisstph-mis.ch/matchbox/fhir/StructureDefinition/birthDateEstimator']) &lt;= 1">extension with URL = 'https://fhir.dk.swisstph-mis.ch/matchbox/fhir/StructureDefinition/birthDateEstimator': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.dk.swisstph-mis.ch/matchbox/fhir/StructureDefinition/caregiver']) &gt;= 1">extension with URL = 'https://fhir.dk.swisstph-mis.ch/matchbox/fhir/StructureDefinition/caregiver': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.dk.swisstph-mis.ch/matchbox/fhir/StructureDefinition/motherVitalStatus']) &lt;= 1">extension with URL = 'https://fhir.dk.swisstph-mis.ch/matchbox/fhir/StructureDefinition/motherVitalStatus': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.dk.swisstph-mis.ch/matchbox/fhir/StructureDefinition/fatherVitalStatus']) &lt;= 1">extension with URL = 'https://fhir.dk.swisstph-mis.ch/matchbox/fhir/StructureDefinition/fatherVitalStatus': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
