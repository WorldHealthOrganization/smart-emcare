...
## StructureMap: Ccc.b18-21.symptoms.2m.m 

| | |
| :--- | :--- |
| *Official URL*:https://smart.who.int/ccc/StructureMap/Ccc.b18-21.symptoms.2m.m | *Version*:0.1.0 |
| Active as of 2026-04-07 | *Computable Name*:Ccc.b18-21.symptoms.2m.m |
...
```json
{
  ...
  "url" : "https://smart.who.int/ccc/StructureMap/Ccc.b18-21.symptoms.2m.m",
  "version" : "0.1.0",
  ...
  "group" : [{
    ...
    },
    {
      ...
      "source" : [{
        ...
        "listMode" : "first",
        "variable" : "item",
        "condition" : "(linkId = 'Ccc.B18S1.DE02') and answer.exists()"
      }],
      "rule" : [{
        "name" : "94862cbd",
        "source" : [{
        ...
        },
        {
          ...
          "rule" : [{
            ...
            "dependent" : [{
              "name" : "CccobservationCccb18s1de02",
              "variable" : ["src", "tgt"]
            }]
          }]
        }]
    ...
    },
    {
      ...
      "source" : [{
        ...
        "listMode" : "first",
        "variable" : "item",
        "condition" : "(linkId = 'Ccc.B21S1.DE06') and answer.exists()"
      }],
      "rule" : [{
        "name" : "ce9b0830",
        "source" : [{
        ...
        },
        {
          ...
          "rule" : [{
            ...
            "dependent" : [{
              "name" : "CccobservationCccb21s1de06",
              "variable" : ["src", "tgt"]
            }]
          }]
        }]
