...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:CommunicationRequest/f:medium</sch:title>
    <sch:rule context="f:CommunicationRequest/f:medium">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.org/guides/who/emc-cds/StructureDefinition/sms']) &lt;= 1">extension with URL = 'http://fhir.org/guides/who/emc-cds/StructureDefinition/sms': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>CommunicationRequest.medium.extension</sch:title>
    <sch:rule context="f:CommunicationRequest/f:medium/f:extension">
  ...
  <sch:pattern>
    <sch:title>CommunicationRequest.medium.coding</sch:title>
    <sch:rule context="f:CommunicationRequest/f:medium/f:coding">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>CommunicationRequest.medium.text</sch:title>
    <sch:rule context="f:CommunicationRequest/f:medium/f:text">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
