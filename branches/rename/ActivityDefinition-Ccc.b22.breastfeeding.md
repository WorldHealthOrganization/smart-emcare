...
## ActivityDefinition: Ccc.b22.breastfeeding 

| | |
| :--- | :--- |
| *Official URL*:https://smart.who.int/ccc/ActivityDefinition/Ccc.b22.breastfeeding | *Version*:0.1.0 |
| Active as of 2026-04-07 | *Computable Name*: |
| **Usage:**Workflow Task: Collect infornation with questionnaire Ccc.B22.BreastFeeding | |
...
```json
{
  ...
  "url" : "https://smart.who.int/ccc/ActivityDefinition/Ccc.b22.breastfeeding",
  "version" : "0.1.0",
  "status" : "active",
  "experimental" : false,
  ...
  "useContext" : [{
    ...
    "valueCodeableConcept" : {
      "coding" : [{
        ...
        "code" : "PATDOC",
        "display" : "Collect infornation with questionnaire Ccc.B22.BreastFeeding"
      }]
    }
  }],
  "jurisdiction" : [{
