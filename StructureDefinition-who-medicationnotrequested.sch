...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationRequest">
      ...
      <sch:assert test="exists(f:extension)">To indicate what medication was not requested, either at least one coding in the codeableconcept or a valueset-reference extension shall be provided</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
