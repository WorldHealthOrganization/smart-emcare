...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Encounter">
      ...
      <sch:assert test="count(f:extension[@url = 'https://fhir.dk.swisstph-mis.ch/matchbox/fhir/StructureDefinition/refered']) &lt;= 1">extension with URL = 'https://fhir.dk.swisstph-mis.ch/matchbox/fhir/StructureDefinition/refered': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
