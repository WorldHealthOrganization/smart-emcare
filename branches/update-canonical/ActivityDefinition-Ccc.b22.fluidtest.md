...
## ActivityDefinition: Ccc.b22.fluidtest 

| | |
| :--- | :--- |
| *Official URL*:https://smart.who.int/ccc/ActivityDefinition/Ccc.b22.fluidtest | *Version*:0.1.0 |
| Active as of 2026-04-07 | *Computable Name*: |
| **Usage:**Workflow Task: Collect infornation with questionnaire Ccc.B22.FluidTest | |
...
```json
{
  ...
  "url" : "https://smart.who.int/ccc/ActivityDefinition/Ccc.b22.fluidtest",
  "version" : "0.1.0",
  "status" : "active",
  "experimental" : false,
  ...
  "useContext" : [{
    ...
    "valueCodeableConcept" : {
      "coding" : [{
        ...
        "code" : "PATDOC",
        "display" : "Collect infornation with questionnaire Ccc.B22.FluidTest"
      }]
    }
  }],
  "jurisdiction" : [{
