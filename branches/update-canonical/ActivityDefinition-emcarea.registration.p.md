...
## ActivityDefinition: emcarea.registration.p 

| | |
| :--- | :--- |
| *Official URL*:https://smart.who.int/ccc/ActivityDefinition/emcarea.registration.p | *Version*:0.1.0 |
| Active as of 2026-04-07 | *Computable Name*: |
| **Usage:**Workflow Task: Collect infornation with questionnaire EmCareA.Registration.P | |
...
```json
{
  ...
  },
  {
    ...
    "valueCanonical" : "https://smart.who.int/ccc/Questionnaire/emcarea.registration.p"
  }],
  "url" : "https://smart.who.int/ccc/ActivityDefinition/emcarea.registration.p",
  "version" : "0.1.0",
  "status" : "active",
  "experimental" : false,
  ...
  "useContext" : [{
    ...
    "valueCodeableConcept" : {
      "coding" : [{
        ...
        "code" : "PATDOC",
        "display" : "Collect infornation with questionnaire EmCareA.Registration.P"
      }]
    }
  }],
  "jurisdiction" : [{
