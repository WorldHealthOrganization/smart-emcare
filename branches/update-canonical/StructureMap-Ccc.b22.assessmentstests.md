...
```json
{
  ...
  "url" : "https://smart.who.int/ccc/StructureMap/Ccc.b22.assessmentstests",
  "version" : "0.1.0",
  ...
  "group" : [{
    ...
    },
    {
      ...
      "rule" : [{
        ...
        "source" : [{
          ...
          "listMode" : "first",
          "variable" : "itm1",
          "condition" : "linkId = 'Ccc.B22.BronchodilatorTest'"
        }],
        "rule" : [{
          "name" : "34815add",
          "source" : [{
    ...
    },
    {
      ...
      "source" : [{
        ...
        "listMode" : "first",
        "variable" : "itm1",
        "condition" : "linkId = 'Ccc.B22.BreastFeeding'"
      }],
      "rule" : [{
        "name" : "95a734dc",
        "source" : [{
          ...
          "listMode" : "first",
          "variable" : "item",
          "condition" : "(linkId = 'Ccc.B22.DE41') and answer.exists()"
        }],
        "rule" : [{
          "name" : "9de4a229",
          "source" : [{
    ...
    },
    {
      ...
      "rule" : [{
        ...
        "source" : [{
          ...
          "listMode" : "first",
          "variable" : "item",
          "condition" : "(linkId = 'Ccc.B22.DE28') and answer.exists()"
        }],
        "rule" : [{
          "name" : "5cc117e5",
          "source" : [{
    ...
    },
    {
      ...
      "rule" : [{
        ...
        "source" : [{
          ...
          "listMode" : "first",
          "variable" : "item",
          "condition" : "(linkId = 'Ccc.B22.DE29') and answer.exists()"
        }],
        "rule" : [{
          "name" : "a568a312",
          "source" : [{
    ...
    },
    {
      ...
      "rule" : [{
        ...
        "source" : [{
          ...
          "listMode" : "first",
          "variable" : "item",
          "condition" : "(linkId = 'Ccc.B22.DE30') and answer.exists()"
        }],
        "rule" : [{
          "name" : "6aff1bf2",
          "source" : [{
    ...
    },
    {
      ...
      "rule" : [{
        ...
        "source" : [{
          ...
          "listMode" : "first",
          "variable" : "item",
          "condition" : "(linkId = 'Ccc.B22.DE31') and answer.exists()"
        }],
        "rule" : [{
          "name" : "47ecf4e4",
          "source" : [{
    ...
    },
    {
      ...
      "rule" : [{
        ...
        "source" : [{
          ...
          "listMode" : "first",
          "variable" : "item",
          "condition" : "(linkId = 'Ccc.B22.DE32') and answer.exists()"
        }],
        "rule" : [{
          "name" : "77934152",
          "source" : [{
    ...
    },
    {
      ...
      "rule" : [{
        ...
        "source" : [{
          ...
          "listMode" : "first",
          "variable" : "item",
          "condition" : "(linkId = 'Ccc.B22.DE33') and answer.exists()"
        }],
        "rule" : [{
          "name" : "b81929fc",
          "source" : [{
    ...
    },
    {
      ...
      "rule" : [{
        ...
        "source" : [{
          ...
          "listMode" : "first",
          "variable" : "item",
          "condition" : "(linkId = 'Ccc.B22.DE34') and answer.exists()"
        }],
        "rule" : [{
          "name" : "9f5867b0",
          "source" : [{
    ...
    },
    {
      ...
      "rule" : [{
        ...
        "source" : [{
          ...
          "listMode" : "first",
          "variable" : "item",
          "condition" : "(linkId = 'Ccc.B22.DE35') and answer.exists()"
        }],
        "rule" : [{
          "name" : "6b8eb7c7",
          "source" : [{
    ...
    },
    {
      ...
      "rule" : [{
        ...
        "source" : [{
          ...
          "listMode" : "first",
          "variable" : "item",
          "condition" : "(linkId = 'Ccc.B22.DE36') and answer.exists()"
        }],
        "rule" : [{
          "name" : "e67b8382",
          "source" : [{
    ...
    },
    {
      ...
      "rule" : [{
        ...
        "source" : [{
          ...
          "listMode" : "first",
          "variable" : "item",
          "condition" : "(linkId = 'Ccc.B22.DE42') and answer.exists()"
        }],
        "rule" : [{
          "name" : "56a5bbd9",
          "source" : [{
    ...
    },
    {
      ...
      "rule" : [{
        ...
        "source" : [{
          ...
          "listMode" : "first",
          "variable" : "item",
          "condition" : "(linkId = 'Ccc.B22.DE44') and answer.exists()"
        }],
        "rule" : [{
          "name" : "0e593cb2",
          "source" : [{
    ...
    },
    {
      ...
      "source" : [{
        ...
        "listMode" : "first",
        "variable" : "itm1",
        "condition" : "linkId = 'Ccc.B22.Hemoglobin'"
      }],
      "rule" : [{
        "name" : "12925695",
        "source" : [{
    ...
    },
    {
      ...
      "source" : [{
        ...
        "listMode" : "first",
        "variable" : "itm1",
        "condition" : "linkId = 'Ccc.B22.SecondTemperature'"
      }],
      "rule" : [{
        "name" : "39718bc0",
        "source" : [{
          ...
          "listMode" : "first",
          "variable" : "item",
          "condition" : "(linkId = 'Ccc.B22.DE47') and answer.exists()"
        }],
        "rule" : [{
          "name" : "6ac0c1c9",
          "source" : [{
    ...
    },
    {
      ...
      "rule" : [{
        ...
        "source" : [{
          ...
          "listMode" : "first",
          "variable" : "item",
          "condition" : "(linkId = 'Ccc.B22.DE46') and answer.exists()"
        }],
        "rule" : [{
          "name" : "9266b262",
          "source" : [{
    ...
    },
    {
      ...
      "rule" : [{
        ...
        "source" : [{
          ...
          "listMode" : "first",
          "variable" : "item",
          "condition" : "(linkId = 'Ccc.B22.DE50') and answer.exists()"
        }],
        "rule" : [{
          "name" : "82120e52",
          "source" : [{
  ...
  },
  {
    ...
    "rule" : [{
      "name" : "id-CccobservationCccb22de36",
      "source" : [{
        "context" : "src"
      }],
      "target" : [{
    ...
    {
      "name" : "code-CccobservationCccb22de36",
      "source" : [{
        "context" : "src",
        "element" : "subject",
        "variable" : "subject"
