...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      ...
      <sch:assert test="count(f:extension[@url = 'http://fhir.org/guides/who/emc-cds/StructureDefinition/birthdateestimator']) &lt;= 1">extension with URL = 'http://fhir.org/guides/who/emc-cds/StructureDefinition/birthdateestimator': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient/f:identifier">
      <sch:assert test="count(f:extension[@url = 'http://fhir.org/guides/who/emc-cds/StructureDefinition/unknown']) &lt;= 1">extension with URL = 'http://fhir.org/guides/who/emc-cds/StructureDefinition/unknown': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:title>f:Patient/f:identifier/f:id</sch:title>
  ...
  <sch:pattern>
    <sch:title>Patient.identifier.id.extension</sch:title>
    <sch:rule context="f:Patient/f:identifier/f:id/f:extension">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
      <sch:assert test="exists(f:extension)!=exists(f:*[starts-with(local-name(.), 'value')])">Must have either extensions or value[x], not both (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
