...
## StructureMap: emcareb.registration.e 

| | |
| :--- | :--- |
| *Official URL*:https://smart.who.int/ccc/StructureMap/emcareb.registration.e | *Version*:0.1.0 |
| Active as of 2026-04-07 | *Computable Name*:emcareb.registration.e |
...
```json
{
  ...
  "url" : "https://smart.who.int/ccc/StructureMap/emcareb.registration.e",
  "version" : "0.1.0",
  ...
  {
    "url" : "https://smart.who.int/ccc/StructureDefinition/emcareencounter",
    "mode" : "produced",
  ...
  "group" : [{
    ...
    },
    {
      ...
      "source" : [{
        ...
        "listMode" : "first",
        "variable" : "item",
        "condition" : "(linkId = 'EmCare.B3.DE05') and answer.exists()"
      }],
      "rule" : [{
        "name" : "a322e7db",
        "source" : [{
  ...
  },
  {
    ...
    "rule" : [{
      ...
      "source" : [{
        ...
        "listMode" : "first",
        "variable" : "item",
        "condition" : "(linkId = 'EmCare.B3.DE01') and answer.exists()"
      }],
      "rule" : [{
        "name" : "aemcareb3de01",
        "source" : [{
    ...
    },
    {
      ...
      "source" : [{
        ...
        "listMode" : "first",
        "variable" : "item",
        "condition" : "(linkId = 'EmCare.B3.DE06') and answer.exists()"
      }],
      "rule" : [{
        "name" : "aemcareb3de06",
        "source" : [{
