# emcare.b22.respiratoryrate - WHO FHIR Implementation Guide (IG): Integrated Management of Childhood Illness (IMCI) in emergencies v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **emcare.b22.respiratoryrate**

## ActivityDefinition: emcare.b22.respiratoryrate 

| | |
| :--- | :--- |
| *Official URL*:https://smart.who.int/ccc/ActivityDefinition/emcare.b22.respiratoryrate | *Version*:0.1.0 |
| Active as of 2026-04-07 | *Computable Name*: |
| **Usage:**Workflow Task: Collect infornation with questionnaire EmCare.B22.RespiratoryRate | |
...
```json
{
  ...
  "url" : "https://smart.who.int/ccc/ActivityDefinition/emcare.b22.respiratoryrate",
  "version" : "0.1.0",
  "status" : "active",
  "experimental" : false,
  ...
  "useContext" : [{
    ...
    "valueCodeableConcept" : {
      "coding" : [{
        ...
        "code" : "PATDOC",
        "display" : "Collect infornation with questionnaire EmCare.B22.RespiratoryRate"
      }]
    }
  }],
  "jurisdiction" : [{
