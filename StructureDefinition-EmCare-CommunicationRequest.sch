...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:CommunicationRequest">
      ...
      <sch:assert test="count(f:extension[@url = 'https://fhir.dk.swisstph-mis.ch/matchbox/fhir/StructureDefinition/smsNotifications']) &gt;= 1">extension with URL = 'https://fhir.dk.swisstph-mis.ch/matchbox/fhir/StructureDefinition/smsNotifications': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.dk.swisstph-mis.ch/matchbox/fhir/StructureDefinition/smsNotifications']) &lt;= 1">extension with URL = 'https://fhir.dk.swisstph-mis.ch/matchbox/fhir/StructureDefinition/smsNotifications': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
