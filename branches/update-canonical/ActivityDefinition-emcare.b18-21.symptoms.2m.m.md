...
## ActivityDefinition: emcare.b18-21.symptoms.2m.m 

| | |
| :--- | :--- |
| *Official URL*:https://smart.who.int/ccc/ActivityDefinition/emcare.b18-21.symptoms.2m.m | *Version*:0.1.0 |
| Active as of 2026-04-07 | *Computable Name*: |
| **Usage:**Workflow Task: Collect infornation with questionnaire EmCare.B18-21.Symptoms.2m.m | |
...
```json
{
  ...
  },
  {
    ...
    "valueCanonical" : "https://smart.who.int/ccc/Questionnaire/emcare.b18-21.symptoms.2m.m"
  }],
  "url" : "https://smart.who.int/ccc/ActivityDefinition/emcare.b18-21.symptoms.2m.m",
  "version" : "0.1.0",
  "status" : "active",
  "experimental" : false,
  ...
  "useContext" : [{
    ...
    "valueCodeableConcept" : {
      "coding" : [{
        ...
        "code" : "PATDOC",
        "display" : "Collect infornation with questionnaire EmCare.B18-21.Symptoms.2m.m"
      }]
    }
  }],
  "jurisdiction" : [{
