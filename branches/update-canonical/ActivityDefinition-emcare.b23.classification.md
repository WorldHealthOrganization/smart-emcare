...
## ActivityDefinition: emcare.b23.classification 

| | |
| :--- | :--- |
| *Official URL*:https://smart.who.int/ccc/ActivityDefinition/emcare.b23.classification | *Version*:0.1.0 |
| Active as of 2026-04-07 | *Computable Name*: |
| **Usage:**Workflow Task: Collect infornation with questionnaire EmCare.B23.Classification | |
...
```json
{
  ...
  },
  {
    ...
    "valueCanonical" : "https://smart.who.int/ccc/Questionnaire/emcare.b23.classification"
  }],
  "url" : "https://smart.who.int/ccc/ActivityDefinition/emcare.b23.classification",
  "version" : "0.1.0",
  "status" : "active",
  "experimental" : false,
  ...
  "useContext" : [{
    ...
    "valueCodeableConcept" : {
      "coding" : [{
        ...
        "code" : "PATDOC",
        "display" : "Collect infornation with questionnaire EmCare.B23.Classification"
      }]
    }
  }],
  "jurisdiction" : [{
