...
## ActivityDefinition: emcare.b7.lti-dangersigns 

| | |
| :--- | :--- |
| *Official URL*:https://smart.who.int/ccc/ActivityDefinition/emcare.b7.lti-dangersigns | *Version*:0.1.0 |
| Active as of 2026-04-07 | *Computable Name*: |
| **Usage:**Workflow Task: Collect infornation with questionnaire EmCare.B7.LTI-DangerSigns | |
...
```json
{
  ...
  },
  {
    ...
    "valueCanonical" : "https://smart.who.int/ccc/Questionnaire/emcare.b7.lti-dangersigns"
  }],
  "url" : "https://smart.who.int/ccc/ActivityDefinition/emcare.b7.lti-dangersigns",
  "version" : "0.1.0",
  "status" : "active",
  "experimental" : false,
  ...
  "useContext" : [{
    ...
    "valueCodeableConcept" : {
      "coding" : [{
        ...
        "code" : "PATDOC",
        "display" : "Collect infornation with questionnaire EmCare.B7.LTI-DangerSigns"
      }]
    }
  }],
  "jurisdiction" : [{
